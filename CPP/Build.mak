...
!IFNDEF OLD_COMPILER
CFLAGS = $(CFLAGS) -GS -guard:cf -guard:ehcont -Zc:forScope -Zc:wchar_t
!IF "$(PLATFORM)" == "x64"
CFLAGS = $(CFLAGS) -guard:xfg
!ENDIF
!IFNDEF UNDER_CE
!IF "$(CC)" != "clang-cl"
CFLAGS = $(CFLAGS) -MP4
...
LFLAGS = $(LFLAGS) -nologo -OPT:REF -OPT:ICF -GUARD:CF -CETCOMPAT
!IF "$(PLATFORM)" == "x64"
LFLAGS = $(LFLAGS) -GUARD:XFG
!ENDIF
